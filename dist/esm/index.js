...
var CurrencyInput = /** @class */ (function (_super) {
    ...
    CurrencyInput.prepareProps = function (props) {
        ...
        var _a = mask(initialValue, props.precision, props.decimalSeparator, props.thousandSeparator, props.allowNegative, props.prefix, props.suffix), maskedValue = _a.maskedValue, value = _a.value;
    ...
    CurrencyInput.prototype.handleChangeEvent = function (event) {
        ...
        this.setState(function (prevState, props) {
            var _a = mask(event.target.value, props.precision, props.decimalSeparator, props.thousandSeparator, props.allowNegative, props.prefix, props.suffix), maskedValue = _a.maskedValue, value = _a.value;
