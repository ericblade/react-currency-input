...
describe('input caret selection', function() {
    describe('default params: precision = 2, prefix = $, suffix = " USD"', () => {
        ...
        // THIS TEST IS FAILING, CARET IS MOVING TO END OF INPUT WHEN ENTERING ELSEWHERE BUT NUMBER OF DIGITS DOES NOT CHANGE
        it.skip('left arrow then enter 1 sets value to $0.10 and leaves caret selection one from end', () => {
        ...
        // THIS TEST IS ALSO FAILING, SEE ABOVE.
        it.skip('left arrow twice then enter 1 sets value to $1.00 and leaves caret selection 2 from end', () => {
        ...
        it.skip('enter 123456 then backspace sets value to $123.45 and leaves caret selection at end', () => {
            cy.get('#currency-input').focus().wait(1).type('123456').then((el) => {
                const input = el[0] as HTMLInputElement;
                const inputValue = input.value;
                const inputLength = inputValue.length;
        ...
        it.skip('enter 123456 then backspace twice sets value to $12.34 and leaves caret selection at end', () => {
            cy.get('#currency-input').focus().wait(1).type('123456').then((el) => {
                const input = el[0] as HTMLInputElement;
                const inputValue = input.value;
                const inputLength = inputValue.length;
